...
if (isset($_GET['delete'])) {
    $id = $_GET['id'];
    $query = mysqli_query($konek,"DELETE FROM fadli where id = '$id'");
    if($query)
    {
        ?>
        ...
        <?php
    header('refresh:3; URL=http://localhost/fadli/admin.php?page=anggota');
    }
} 
if (isset($_POST['save'])) {
    ...
    if($query_insert)
    {
        ...
        <?php
    header('refresh:3; URL=http://localhost/APLIKASI_PEMROGRAMAN_FADHLIHANAHMADHAFIZ_XIIRPL1/admin.php?page=anggota');
    }
